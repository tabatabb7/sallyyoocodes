    ...
    <div className="App">
      ...
      <div className="aboutme">
        ...
        <p>
          ...
          getting accepted into Grace Hopper, and falling in love with learning
          new frameworks and technologies. One of my favorite things is starting
          off with a single line of code and breathing life into an app with a
        ...
        <p>
          ...
          pair-program and debug through Zoom. I am eager to bring this energy
          and enthusiasm for remote pair-programming to my future team!
        </p>
      </div>
    </div>
  );
